...
public class Cuckoo_Hash {
    ...
    private static ArrayList<KV> stash = new ArrayList<>();//store evicted elements
    ...
    public void Setup(KV[] kv_list, int level) throws Exception {
        ...
        for (int i = 0; i < kv_list.length; i++) {
            Cuckoo_Hash.InsertEntry(i,kv_list);
        }
    ...
    static void InsertEntry(int index,KV[] kv_list) {
        int count = 0;
        int h;
